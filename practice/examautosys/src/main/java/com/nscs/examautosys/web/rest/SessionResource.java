...
/**
 * REST controller for managing {@link com.nscs.examautosys.domain.Session}.
 */
@RestController
@RequestMapping("/api")
public class SessionResource {
    ...
    public ResponseEntity<SessionDTO> partialUpdateSession(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sessionDTO.getId().toString())
        );
    }
